...
<form action="<c:url value='/login'/>" method="post" onsubmit="return formCheck(this);">
    <%--<form action="/simpleWeb/test5" method="post" onsubmit="return formCheck(this);">--%>
    ...
    <button>로그인</button>
    <div>
        <label><input type="checkbox" name="rememberId" ${cookie.id.value!=null ? "checked":""}> 아이디 기억</label> |
        <a href="">비밀번호 찾기</a> |
        <a href="">회원가입</a>
    </div>
    <script>
